...
import com.example.uccexample.domain.service.HistoriaClinicaService;
...
public class HistoriaClinicaController {
    ...
    public List<HistoriaClinicaDTO> getAll() {
        return historiaClinicaService.obtenerTodo();
    }

    @PostMapping("/")
    public HistoriaClinicaDTO save(@RequestBody HistoriaClinicaDTO historiaClinica) {
